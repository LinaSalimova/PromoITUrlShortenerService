...
Этот проект представляет собой сервис для создания коротких ссылок с дополнительными функциями управления.

## Функциональность

- Создание коротких уникальных ссылок для каждого пользователя
- Ограничение количества переходов по ссылке
- Автоматическое удаление устаревших ссылок
- Уведомления пользователей о статусе их ссылок
